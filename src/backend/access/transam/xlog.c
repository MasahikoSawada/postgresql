		...
		case WAL_LEVEL_REPLICA:
			{
				...
				/*
				 * With wal_level='replica', XLogLogicalInfo indicates the
				 * actual WAL level unless we're in the status change.
				 */
...
xlog_redo(XLogReaderState *record)
{
	...
	else if (info == XLOG_PARAMETER_CHANGE)
	{
		...
		if (xlrec.wal_level == WAL_LEVEL_LOGICAL)
		{
			 ...
			 * unconditionally enable the logical decoding.
			 */
