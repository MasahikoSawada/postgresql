...
DATA(insert OID = 2739 ( pg_stat_get_synchronous_replication_group PGNSP PGUID 12 1 10 0 0 f f f f f t s r 0 0 2249 "" "{25, 25, 23, 23, 25}" "{o,o,o,o,o}" "{name,sync_type,wait_num,sync_priority,sync_state}" _null_ _null_ pg_stat_get_synchronous_replication_group _null_ _null_ _null_ ));
DESCR("statistics : information about currently synchronous replication group");
