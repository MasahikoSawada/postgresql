...
PG_KEYWORD("empty", EMPTY, RESERVED_KEYWORD)
...
PG_KEYWORD("initial", INITIAL, RESERVED_KEYWORD)
...
PG_KEYWORD("matches", MATCHES, UNRESERVED_KEYWORD)
PG_KEYWORD("match_recognize", MATCH_RECOGNIZE, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("one", ONE, RESERVED_KEYWORD)
...
PG_KEYWORD("past", PAST_P, UNRESERVED_KEYWORD)
PG_KEYWORD("pattern", PATTERN, UNRESERVED_KEYWORD)
PG_KEYWORD("per", PER, RESERVED_KEYWORD)
...
PG_KEYWORD("seek", SEEK, RESERVED_KEYWORD)
...
PG_KEYWORD("subset", SUBSET, RESERVED_KEYWORD)
...
PG_KEYWORD("unmatched", UNMATCHED, RESERVED_KEYWORD)
