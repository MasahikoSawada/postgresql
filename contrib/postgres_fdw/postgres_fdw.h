...
extern void postgresPrepareForeignTransaction(FdwXactResolveState *state);
extern void postgresCommitForeignTransaction(FdwXactResolveState *state);
extern void postgresRollbackForeignTransaction(FdwXactResolveState *state);
