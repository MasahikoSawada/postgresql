...
typedef void (*PrepareForeignTransaction_function) (FdwXactResolveState *state);
typedef void (*CommitForeignTransaction_function) (FdwXactResolveState *state);
typedef void (*RollbackForeignTransaction_function) (FdwXactResolveState *state);
